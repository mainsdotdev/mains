          ...
          {modelList.map((m) => {
            ...
            return (
              <Button
                ...
                className={`w-full text-left px-3 py-2 cursor-pointer text-s transition-colors flex items-center gap-2 ${
                  isEffortMenuAnchor
              ...
              <>
                {hoveredModelEffortLevels.map((level) => {
                  ...
                  return (
                    <Button
                      ...
                      className={`w-full flex items-center gap-3 px-3 py-1.5 text-left text-s capitalize transition-colors ${
                        isSelected
                ...
                {hoveredModelSupportsUltracode && (
                  <Button
                    ...
                    className={`w-full flex items-center gap-3 px-3 py-1.5 text-left text-s transition-colors ${
                ...
                {[true, false].map((enabled) => {
                  ...
                  return (
                    <Button
                      ...
                      className={`w-full flex items-center gap-2 px-3 py-1.5 text-left text-s transition-colors ${
                        isSelected
                          ? "bg-primary-200/60 text-primary-950 dark:bg-primary-200/10 dark:text-primary"
                          : "text-primary-700 hover:bg-primary-200/30 dark:text-primary-300 dark:hover:bg-primary-800"
                      }`}
