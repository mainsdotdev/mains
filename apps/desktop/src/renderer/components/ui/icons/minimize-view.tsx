...
/** The inward-arrow counterpart of Maximize's framed icon. */
export default function MinimizeView(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      <path
        ...
        strokeWidth={1.5}
        d="m17 7-4 4m0 0V8.5m0 2.5h2.5M7 17l4-4m0 0H8.5m2.5 0v2.5"
      />
      <path
        fill="currentColor"
        fillRule="evenodd"
