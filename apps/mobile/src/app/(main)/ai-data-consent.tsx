    ...
    <View style={{ flex: 1 }}>
      ...
      >
        ...
        <View style={{ gap: spacing.xs, paddingHorizontal: spacing.sm }}>
          ...
          >
            {isDemo
              ? "This run uses bundled sample data. Nothing leaves this phone for your computer or a third-party AI service."
              : "Mains on your computer will share the following with this third-party AI service to complete your request."}
          </ThemedText>
        </View>
        ...
        >
          {isDemo
            ? "Demo Mode stays on this phone. Review these policies before connecting to Mains on a computer."
