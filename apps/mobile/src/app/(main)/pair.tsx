      ...
      >
        {entryMode === "manual" ? (
          <>
            <ThemedText variant="subhead">
              On the server computer, run “mains-server pair” or copy the pairing link, then paste it here.
            </ThemedText>
            <TextInput
          ...
          <View style={{ gap: spacing.ms, paddingTop: spacing.lg }}>
            ...
            <ThemedText variant="subhead">
              Mains only uses the camera to read a pairing code from your server.
            </ThemedText>
        ...
        <View style={{ gap: spacing.xs, paddingTop: spacing.lg }}>
          <ThemedText variant="footnote" style={{ color: colors.secondaryLabel, textAlign: "center" }}>
            No server nearby? Explore Mains with sample data.
          </ThemedText>
          <Button
            title="Try Demo Mode"
            variant="ghost"
      ...
      return (
        <View style={card}>
          ...
          <View style={{ flexDirection: "row", justifyContent: "flex-end", gap: spacing.sm, paddingTop: spacing.xs }}>
            <Button title={retryLabel} variant="secondary" size="sm" onPress={onRetry} />
            <Button title="Pair with this server" size="sm" onPress={() => onPair(scanState.link)} />
          </View>
        </View>
      );
    case "pairing":
