...
export const CHANNELS = {
  ...
  browser: {
    ...
    showDownloadInFolder: "browser:showDownloadInFolder",
  ...
  runs: {
    ...
    consumeOpenRequest: "runs:consumeOpenRequest",
    ...
    openRequested: "runs:openRequested",
    start: "runs:start",
