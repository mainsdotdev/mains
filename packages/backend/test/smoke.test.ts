...
import type { DatabaseInstance } from "../src/db/types";
...
// ── Seed runner ─────────────────────────────────────────────
import { runSeeds, CURRENT_SEED_VERSION } from "../src/db/seeds";

// ── Services under test ─────────────────────────────────────
import { accountService } from "../src/modules/account/account.service";
import { appSettingsService } from "../src/modules/appSettings/appSettings.service";
...
import { workspaceService } from "../src/modules/workspace";
